...
namespace Nyxpiri.ULTRAKILL.AggressiveAgony
{
    public static class Options
    {
        internal static void Initialize(ConfigFile config)
        {
            ...
            HomingProjectileParryEnergyGain = _config.Bind("Balance.ParryGains", "HomingProjectileParryEnergyGain", 100, "Amount of energy gained when parrying/boosting a homing projectile spawned by pain");
            ...
            MortarParryEnergyGain = _config.Bind("Balance.ParryGains", "MortarParryEnergyGain", 100, "Amount of energy gained when parrying/boosting a mortar spawned by pain");
